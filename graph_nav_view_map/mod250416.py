...
class Options:
    def __init__(self):
        self.path = './sample/KAERI03.walk'
        self.anchoring = False
        self.hide_waypoint_text =  False
        self.hide_world_object_text = False
...
def main():
    ...
    (current_graph, current_waypoints, current_waypoint_snapshots, current_edge_snapshots,
     current_anchors, current_anchored_world_objects) = load_map2(options.path)
